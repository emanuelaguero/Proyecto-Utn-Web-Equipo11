...
nextBtnFirst.addEventListener("click", function (event) {
   ...
   /* FALTA VALIDADACIONES agregar  */
    if (true) {
        ...
        document.querySelector("#errorNombre").innerHTML = " -->El campo nombre solo acepta palabras"
        document.querySelector("#errorApellido").innerHTML = " -->El campo Apellido solo acepta palabras"
        document.querySelector("#errorDni").innerHTML = " -->El campo Dni solo Numeros"
    } 
